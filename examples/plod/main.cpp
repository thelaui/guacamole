...
int main(int argc, char** argv) {
	...
	plod_loader.set_out_of_core_budget_in_mb(8000);
	plod_loader.set_render_budget_in_mb(4000);
	...
	pipe->get_resolve_pass()->screen_space_shadows(false);
	pipe->get_resolve_pass()->screen_space_shadow_radius(1.0);
	pipe->get_resolve_pass()->screen_space_shadow_intensity(0.9);

	pipe->get_resolve_pass()->environment_lighting_mode(gua::ResolvePassDescription::EnvironmentLightingMode::AMBIENT_COLOR);
	pipe->get_resolve_pass()->environment_lighting_texture("data/textures/envlightmap.jpg");

	pipe->get_resolve_pass()->background_mode(gua::ResolvePassDescription::BackgroundMode::SKYMAP_TEXTURE);
	pipe->get_resolve_pass()->background_texture("data/textures/envmap.jpg");
